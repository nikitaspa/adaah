    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto space-y-6">
          {/* Eyebrow badge */}
          <div className="flex flex-wrap items-center justify-center gap-1.5 px-3 py-1.5 rounded-full bg-white border border-[#E6E1D8] shadow-2xs text-[11px] sm:text-xs font-semibold text-[#171717]">
            <span className="w-2 h-2 rounded-full bg-[#C6922E]" />
            <span className="text-[#916718] font-bold">18+ Only</span>
            <span className="text-[#D0C9BD] hidden sm:inline">•</span>
          ...
          <h1 className="font-serif-display text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-[#171717] leading-[1.15] break-words">
            Discover Premium Companionship in Hyderabad
          </h1>

          {/* Supporting Subtitle */}
          <p className="text-sm sm:text-lg text-[#5F5A52] leading-relaxed max-w-2xl font-normal">
          ...
          <div className="w-full max-w-2xl pt-2">
            ...
            <div className="flex flex-wrap items-center justify-center gap-1.5 mt-3.5 text-xs text-[#5F5A52]">
              <span className="font-medium text-[#5F5A52] w-full sm:w-auto text-center sm:text-left mb-1 sm:mb-0">Popular locations:</span>
              {popularLocations.map((loc) => (
                <button
                  ...
                  className="px-3 py-1.5 rounded-full bg-white border border-[#E6E1D8] text-[#171717] hover:text-[#C6922E] hover:border-[#C6922E] transition-colors text-xs font-medium cursor-pointer active:scale-95 shadow-2xs min-h-[32px] flex items-center"
                >
                  {loc.label}
                </button>
              ))}
          ...
          {/* Trust Badges */}
          <div className="pt-2 sm:pt-4 flex flex-wrap items-center justify-center gap-2 sm:gap-6 text-xs text-[#5F5A52]">
